 ...
 */
package cn.stylefeng.guns.modular.activiti.controller.base;
...
public class ModelEditorJsonRestResource implements ModelDataJsonConstants {
  ...
  public Object getEditorJson(@PathVariable String modelId) {
    ...
    if (model != null) {
      try {
        ...
        if (StringUtils.isNotEmpty(metaInfo)) {
          ...
          modelNode = (ObjectNode) objectMapper.readTree(metaInfo);
        } else {
        ...
        //获取模型字节数组
        byte[] editorSourceByte = repositoryService.getModelEditorSource(model.getId());
        //将数组转成String
    ...
    Object resultObject = JSONObject.parse(modelNode.toString());
    return resultObject;
  }
}
